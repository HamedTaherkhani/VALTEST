Here is a draft for the README file based on your project structure and the provided files:
...
Here is an extended section for the **parameters** of `main_train.py` in the README:
